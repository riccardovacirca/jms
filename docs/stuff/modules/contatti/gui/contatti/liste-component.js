...
class ListeComponent extends LitElement {
    ...
    return html`
      <div class="container-fluid py-4">
        <div class="d-flex align-items-center gap-2 mb-4">
          ...
          <button class="btn btn-sm btn-primary ms-auto" @click=${this._newLista}>Nuova</button>
        </div>
      ...
      <div class="container-fluid py-4">
        <div class="d-flex align-items-center gap-2 mb-4">
          ...
          <button class="btn btn-sm btn-outline-success ms-auto"
                  @click=${() => { this._view = 'importer'; }}>Importa da file</button>
        </div>
  ...
  _renderImporter() {
    return html`
      <importer-wizard
        .listaId=${this._lista?.id ?? null}
        @cancel=${() => { this._view = 'contatti'; }}
        @done=${() => { this._view = 'contatti'; this._loadContatti(); }}>
      </importer-wizard>`;
  }
}
