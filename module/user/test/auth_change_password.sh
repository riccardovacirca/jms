#!/bin/bash
#
# Test: auth change password - Auto-generated test
...
echo "=========================================="
echo "Test: auth_change_password"
echo "=========================================="
echo ""
...
case "auth_change_password" in
  auth_generate_password)
    "$CLI_DIR/auth_change_password.sh"
    ;;
  auth_change_password)
    NEW_PASSWORD="${TEST_NEW_PASSWORD:-newpass}"
    "$CLI_DIR/auth_change_password.sh" "$USERNAME" "$PASSWORD" "$NEW_PASSWORD"
    ;;
  account_register)
    ...
    "$CLI_DIR/auth_change_password.sh" "$USERNAME" "$PASSWORD" "$NEW_USER" "$NEW_EMAIL" "$NEW_PASS" "$RUOLO"
    ;;
  *)
    "$CLI_DIR/auth_change_password.sh" "$USERNAME" "$PASSWORD"
    ;;
esac
