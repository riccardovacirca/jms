...
import dev.jms.app.sales.adapter.CampagnaAdapter;
import dev.jms.app.sales.dao.CampagnaDAO;
...
/**
 * Handler per le operazioni sulle campagne (tabella jms_sales_campagne).
...
public class CampagneHandler
{
  ...
  /**
   * GET /api/sales/campagne — lista paginata delle campagne.
   */
  ...
  /**
   * POST /api/sales/campagne — crea una nuova campagna. Restituisce l'id generato.
   */
  ...
  /**
   * GET /api/sales/campagne/{id} — recupera una campagna per id.
   */
  ...
  /**
   * PUT /api/sales/campagne/{id} — aggiorna tutti i campi della campagna.
   */
  ...
  /**
   * DELETE /api/sales/campagne/{id} — elimina una campagna (soft delete).
   */
  ...
  /**
   * GET /api/sales/campagne/{id}/liste — liste associate alla campagna, paginate.
   */
  ...
  /**
   * POST /api/sales/campagne/{id}/liste — aggiunge una lista alla campagna. Body: {@code {"listaId": 42}}.
   */
  ...
  /**
   * DELETE /api/sales/campagne/{id}/liste/{lid} — rimuove una lista dalla campagna.
   */
