...
import dev.jms.app.sales.adapter.ListaAdapter;
import dev.jms.app.sales.dao.ListaDAO;
...
public class ListeHandler
{
  ...
  /**
   * GET /api/sales/liste — lista paginata delle liste.
   */
  ...
  /**
   * POST /api/sales/liste — crea una nuova lista. Restituisce l'id generato.
   */
  ...
  /**
   * GET /api/sales/liste/{id} — recupera una lista per id.
   */
  ...
  /**
   * PUT /api/sales/liste/{id} — aggiorna tutti i campi della lista.
   */
  ...
  /**
   * DELETE /api/sales/liste/{id} — elimina una lista (soft delete).
   */
  ...
  /**
   * PUT /api/sales/liste/{id}/stato — aggiorna solo il campo stato. Body: {@code {"stato": 1}}.
   */
  ...
  /**
   * PUT /api/sales/liste/{id}/scadenza — aggiorna solo la scadenza. Body: {@code {"scadenza": "2026-12-31"}}.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * GET /api/sales/liste/{id}/contatti — contatti della lista, paginati.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * POST /api/sales/liste/{id}/contatti — aggiunge un contatto alla lista. Body: {@code {"contattoId": 42}}.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * DELETE /api/sales/liste/{id}/contatti/{cid} — rimuove un contatto dalla lista.
   */
  ...
  /**
   * GET /api/sales/liste/default — restituisce la lista marcata come default, o null.
   */
  ...
  /**
   * PUT /api/sales/liste/{id}/default — imposta la lista indicata come default.
   */
