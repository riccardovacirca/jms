...
public class ListaDAO
{
  ...
  public List<ListaDTO> findAll(int page, int size) throws Exception
  {
    ...
    sql =
      ...
      "FROM liste l " +
      "LEFT JOIN lista_contatti lc ON lc.lista_id = l.id " +
  ...
  public int count() throws Exception
  {
    ...
    sql = "SELECT COUNT(*) AS n FROM liste WHERE deleted_at IS NULL";
    rows = db.select(sql);
  ...
  public int insert(ListaDTO l) throws Exception
  {
    ...
    sql =
      "INSERT INTO liste (nome, descrizione, consenso, stato, scadenza) " +
      "VALUES (?, ?, ?, ?, ?) " +
      "RETURNING id";
  ...
  public void update(ListaDTO l) throws Exception
  {
    ...
    scadenza = l.scadenza() != null && !l.scadenza().isBlank() ? java.sql.Date.valueOf(l.scadenza()) : null;
    sql = "UPDATE liste SET nome = ?, descrizione = ?, consenso = ?, stato = ?, scadenza = ?, updated_at = NOW() WHERE id = ?";
  ...
  public void delete(int id) throws Exception
  {
    ...
    sql = "UPDATE liste SET deleted_at = NOW() WHERE id = ?";
    db.query(sql, id);
  }
  ...
  public void updateStato(int id, int stato) throws Exception
  {
    ...
    sql = "UPDATE liste SET stato = ?, updated_at = NOW() WHERE id = ?";
  ...
  public void updateScadenza(int id, String scadenza) throws Exception
  {
    ...
    sql = "UPDATE liste SET scadenza = ?, updated_at = NOW() WHERE id = ?";
  ...
  public boolean existsByNome(String nome, Integer excludeId) throws Exception
  {
    ...
    if (excludeId != null) {
      sql = "SELECT COUNT(*) AS n FROM liste WHERE nome = ? AND id != ? AND deleted_at IS NULL";
      rows = db.select(sql, nome, excludeId);
    } else {
      sql = "SELECT COUNT(*) AS n FROM liste WHERE nome = ? AND deleted_at IS NULL";
  ...
  public List<ListaContattoDTO> findContatti(int listaId, int page, int size) throws Exception
  {
    ...
    sql =
      ...
      "JOIN contatti c ON c.id = lc.contatto_id " +
      "WHERE lc.lista_id = ? " +
  ...
  public int countContatti(int listaId) throws Exception
  {
    ...
    sql = "SELECT COUNT(*) AS n FROM lista_contatti WHERE lista_id = ?";
  ...
  public void addContatto(int listaId, int contattoId) throws Exception
  {
    ...
    sql = "INSERT INTO lista_contatti (lista_id, contatto_id) VALUES (?, ?) ON CONFLICT DO NOTHING";
