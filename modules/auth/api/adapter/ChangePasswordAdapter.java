...
/** Deserializza i dati per il cambio password dal body JSON della richiesta. */
public class ChangePasswordAdapter
{
  /** Legge current_password e new_password dal body JSON, valida la policy sulla nuova password. */
