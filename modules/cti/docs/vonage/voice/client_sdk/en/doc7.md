...
*   Make sure you’ve uploaded the certificate to Vonage's server. You need to have a valid admin JWT, meaning a JWT without the `sub` claim. You can [Decode your JWT](https://jwt.io/) to make sure.
