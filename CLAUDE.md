...
cmd module uninstall --name <nome>               # Disinstalla modulo usando il tracker installato
...
```bash
cmd module uninstall --name auth
cmd module uninstall --name cti/vonage
cmd module uninstall --name auth --force   # bypassa controllo dipendenze inverse
```
